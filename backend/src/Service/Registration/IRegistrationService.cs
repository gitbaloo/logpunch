...
namespace Infrastructure
{
    public interface IRegistrationService
    {
        ...
        Task<LogpunchRegistrationDto> EmployeeCorrectionRegistration(Guid userId, Guid? clientId, string type, DateTimeOffset start, DateTimeOffset end, string? firstComment, string? secondComment, Guid correctionOfId);
