...
public interface IRegistrationService
{
    ...
    Task<LogpunchRegistrationDto> CreateNonWorkRegistration(Guid userId, Guid employeeId, DateTimeOffset start, DateTimeOffset end, string type, string? firstComment, string? secondComment);
